(() => {
    ...
    function initSliders() {
        if (document.querySelector(".building__slider")) {
            const buildingSlider = new swiper_core_Swiper(".building__slider", {
            ...
            const buildingSmall = new swiper_core_Swiper(".building-small__slider", {
                ...
                speed: 1e3,
                navigation: {
                    prevEl: ".building-small__swiper-btn-prev",
                    nextEl: ".building-small__swiper-btn-next"
                }
            });
            buildingSmall.controller.control = buildingSlider;
            buildingSlider.controller.control = buildingSmall;
        }
        if (document.querySelector(".tabs-projects__slider")) new swiper_core_Swiper(".tabs-projects__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".tabs-projects__pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".tabs-projects__swiper-btn-prev",
                nextEl: ".tabs-projects__swiper-btn-next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1,
